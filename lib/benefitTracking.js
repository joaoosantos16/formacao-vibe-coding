...
export function getProductivityTopFree() {
  return [
    { project: 'Setup Time Reduction – Line 3', em: 'J. Rosa', occPct: 62, varK: 45.0, varStatus: 'OK', greenDays: 38, critical: false, continuidade: null },
    { project: 'Warehouse Layout Redesign', em: 'M. Alves', occPct: 88, varK: 32.5, varStatus: 'OK', greenDays: 55, critical: false, continuidade: 'Yes' },
    { project: 'Changeover Standardization', em: 'T. Nunes', occPct: 34, varK: 58.0, varStatus: 'NOK', greenDays: 12, critical: true, continuidade: 'No' },
    { project: 'Inventory Accuracy Improvement', em: 'J. Rosa', occPct: 71, varK: 21.0, varStatus: 'OK', greenDays: 44, critical: false, continuidade: null },
    { project: 'Delivery Performance Program', em: 'S. Costa', occPct: 45, varK: 40.0, varStatus: 'NOK', greenDays: 20, critical: true, continuidade: null },
    { project: 'Replenishment Process Redesign', em: 'M. Alves', occPct: 91, varK: 27.0, varStatus: 'OK', greenDays: 58, critical: false, continuidade: 'Yes' },
    { project: 'Batch Size Optimization', em: 'T. Nunes', occPct: 39, varK: 63.0, varStatus: 'NOK', greenDays: 15, critical: true, continuidade: 'No' },
  ];
}
