...
export function getVariablesRows() {
  return [
    ...
    },
    {
      ...
      project: 'Store Network Optimization',
      projectCode: 'NORD-208-POR',
      em: 'rmarques',
      start: '2026-03-15',
      end: '2026-11-15',
      potentialK: 35.0,
    ...
    },
    {
      ...
      project: 'Lab Efficiency Program',
      projectCode: 'HELIX-209-POR',
      em: 'carolinamendes',
      start: '2026-01-10',
      end: '2026-07-31',
      potentialK: 29.0,
      ...
      status: 'Invoiced',
      quarterPotentialK: 7.0,
      quarterInvoicedK: 7.0,
      lastUpdate: '2026-08-15',
    },
    {
      client: 'Orion Freight',
      project: 'Fleet Utilization Improvement',
      projectCode: 'ORION-210-POR',
      em: 'fcortereal',
      start: '2026-04-01',
      end: '2027-01-15',
      potentialK: 51.0,
      invoicedK: 20.0,
      status: 'Pending',
      quarterPotentialK: 13.0,
      quarterInvoicedK: 5.0,
      lastUpdate: '2026-08-08',
    },
    {
      client: 'Verde Foods Co',
      project: 'Cold Chain Reliability',
      projectCode: 'VERDE-211-POR',
      em: 'lramirez',
      start: '2026-05-15',
      end: '2026-12-31',
      potentialK: 22.0,
      invoicedK: 0,
      status: 'Overdue',
      quarterPotentialK: 6.0,
      quarterInvoicedK: 0.0,
      lastUpdate: '2026-08-01',
    },
    {
      client: 'Atlas Manufacturing',
      project: 'Production Line Balancing',
      projectCode: 'ATLAS-212-POR',
      em: 'mcorrea',
      start: '2026-02-01',
      end: '2026-10-31',
      potentialK: 48.0,
    ...
    {
      client: 'Prime Distribution',
      project: 'Distribution Center Redesign',
      projectCode: 'PRIME-213-POR',
      em: 'luissantos',
      start: '2026-01-01',
      end: '2026-06-30',
      potentialK: 37.0,
    ...
    },
    {
      ...
      project: 'Plant Commissioning Support',
      projectCode: 'SOLAR-214-POR',
      em: 'mgamboa',
      start: '2026-06-01',
      end: '2027-03-31',
      potentialK: 44.0,
      invoicedK: 0,
      status: 'Overdue',
      quarterPotentialK: 11.0,
      quarterInvoicedK: 0.0,
      lastUpdate: '2026-07-28',
    },
    {
      client: 'Core Industrial',
      project: 'Materials Flow Redesign',
      projectCode: 'CORE-215-POR',
      em: 'fvasconcelos',
      start: '2026-03-01',
      end: '2026-09-30',
      potentialK: 26.0,
      ...
      status: 'Pending',
      quarterPotentialK: 7.0,
      quarterInvoicedK: 3.0,
      lastUpdate: '2026-08-14',
    },
    {
      client: 'Nexa Systems',
      project: 'ERP Rollout Support',
      projectCode: 'NEXA-216-POR',
      em: 'joaoferreira',
      start: '2026-04-15',
      end: '2026-12-31',
      potentialK: 31.0,
    ...
    },
    {
      ...
      status: 'Invoiced',
      quarterPotentialK: 11.0,
      quarterInvoicedK: 11.0,
      lastUpdate: '2026-08-16',
    },
    {
      client: 'Bridgeport Logistics',
      project: 'Cross-Dock Efficiency',
      projectCode: 'BRIDGE-218-POR',
      em: 'mmela',
      start: '2026-03-10',
      end: '2026-11-30',
      potentialK: 33.0,
    ...
    },
    {
      ...
      project: 'Assembly Line Certification',
      projectCode: 'FALCON-219-POR',
      em: 'rafaelrodrigues',
      start: '2026-05-01',
      end: '2027-02-28',
      potentialK: 28.0,
    ...
    {
      client: 'Terra Agrifoods',
      project: 'Harvest Scheduling Optimization',
      projectCode: 'TERRA-220-POR',
      em: 'valves',
      start: '2026-02-15',
      end: '2026-09-30',
      potentialK: 39.0,
    ...
    {
      client: 'Voxel Robotics',
      project: 'Robotic Cell Commissioning',
      projectCode: 'VOXEL-221-POR',
      em: 'jsantos',
      start: '2026-01-20',
      end: '2026-07-15',
      potentialK: 46.0,
      ...
      status: 'Invoiced',
      quarterPotentialK: 12.0,
      quarterInvoicedK: 12.0,
      lastUpdate: '2026-08-21',
    },
    {
      client: 'Lumen Media Group',
      project: 'Content Ops Streamlining',
      projectCode: 'LUMEN-222-POR',
      em: 'pmramos',
      start: '2026-06-01',
      end: '2027-01-31',
      potentialK: 24.0,
    ...
    {
      client: 'Grainworks Milling',
      project: 'Mill Throughput Improvement',
      projectCode: 'GRAIN-223-POR',
      em: 'cfalcato',
      start: '2026-03-01',
      end: '2026-10-15',
      potentialK: 30.0,
    ...
    },
    {
      ...
      project: 'Guest Service Standardization',
      projectCode: 'HAVEN-224-POR',
      em: 'ccarmo',
      start: '2026-01-10',
      end: '2026-06-30',
      potentialK: 41.0,
      ...
      status: 'Invoiced',
      quarterPotentialK: 10.0,
      quarterInvoicedK: 10.0,
      lastUpdate: '2026-08-23',
    },
    {
      client: 'Pivot Insurance Services',
      project: 'Claims Processing Redesign',
      projectCode: 'PIVOT-225-POR',
      em: 'icardoso',
      start: '2026-04-01',
      end: '2026-12-15',
      potentialK: 27.0,
...
export function getProductivityTopFree() {
  return [
    ...
    { project: 'NEXA-216-POR', em: 'joaoferreira', occPct: 52, varK: 31.0, varStatus: 'NOK', greenDays: 21, critical: true, continuidade: null },
    { project: 'QUANT-217-POR', em: 'marianapereira', occPct: 89, varK: 42.0, varStatus: 'OK', greenDays: 54, critical: false, continuidade: 'Yes' },
    { project: 'BRIDGE-218-POR', em: 'mmela', occPct: 64, varK: 33.0, varStatus: 'OK', greenDays: 36, critical: false, continuidade: null },
    { project: 'FALCON-219-POR', em: 'rafaelrodrigues', occPct: 47, varK: 28.0, varStatus: 'NOK', greenDays: 19, critical: true, continuidade: 'No' },
    { project: 'TERRA-220-POR', em: 'valves', occPct: 73, varK: 39.0, varStatus: 'OK', greenDays: 42, critical: false, continuidade: null },
    { project: 'VOXEL-221-POR', em: 'jsantos', occPct: 81, varK: 46.0, varStatus: 'OK', greenDays: 49, critical: false, continuidade: 'Yes' },
    { project: 'LUMEN-222-POR', em: 'pmramos', occPct: 36, varK: 24.0, varStatus: 'NOK', greenDays: 13, critical: true, continuidade: null },
    { project: 'GRAIN-223-POR', em: 'cfalcato', occPct: 68, varK: 30.0, varStatus: 'OK', greenDays: 37, critical: false, continuidade: null },
    { project: 'HAVEN-224-POR', em: 'ccarmo', occPct: 92, varK: 41.0, varStatus: 'OK', greenDays: 57, critical: false, continuidade: 'Yes' },
    { project: 'PIVOT-225-POR', em: 'icardoso', occPct: 44, varK: 27.0, varStatus: 'NOK', greenDays: 18, critical: true, continuidade: 'No' },
  ];
}
...
//
// Occupation (left axis) — "Real" is the measured trend up to "now" only;
// a real measurement is never a flat constant, so there's no separate
// "Objective" line holding one number, and no forecast either — the
// forecast in this chart belongs to green days, not occupation.
//
...
// per getGreenDaysAvailable). "Forecast" continues from "now" by
// extrapolating the slope of the last few Real weeks — it's what lets
// the team see when the budget runs out at the current burn rate.
const WEEKS = 12;
...
export function getProjectWeeklySeries(projectCode) {
  ...
  // Real occupation — measured up to "now" only, no extrapolation. The
  // forecast in this chart is about green days (the budget being
  // controlled), not occupation.
  const startOcc = 90;
  const real = [];
  ...
  // Forecast continues the green days balance from "now", extrapolating
  // the slope of its last few Real weeks (same technique the occupation
  // forecast used to use) — projects when the budget runs out at the
  // current burn rate.
  const slopeWindow = realGreenDays.slice(-3);
  const avgSlope = (slopeWindow[slopeWindow.length - 1] - slopeWindow[0]) / (slopeWindow.length - 1);
  const forecastGreenDays = [realGreenDays[NOW_WEEK_INDEX]];
  for (let w = NOW_WEEK_INDEX + 1; w < WEEKS; w++) {
    forecastGreenDays.push(Math.max(0, Math.round(forecastGreenDays[forecastGreenDays.length - 1] + avgSlope)));
  }
  ...
  return Array.from({ length: WEEKS }, (_, w) => ({
    ...
    forecastGreenDays: w >= NOW_WEEK_INDEX ? forecastGreenDays[w - NOW_WEEK_INDEX] : null,
  }));
}

export const PROJECT_OVERVIEW_NOW_WEEK_INDEX = NOW_WEEK_INDEX;

// Real Kaizen career ladder (given by the team). "Trainee" is the first
// confirmed junior title below "Consultant" — there are said to be more,
// not yet specified; ask before inventing another one.
...
const KNOWN_CONSULTANT_STATS = {
  ppereira: { level: 'Trainee', occPct: 82, fridayUtilPct: 65 }, // Pedro Pereira
  msoares: { level: 'Manager', occPct: 88, fridayUtilPct: 70 },
  asaraiva: { level: 'Trainee', occPct: 10, fridayUtilPct: 0 }, // Saraiva
...
// Average occupation trend for a set of consultants (defaults to
// everyone) over the same 12-week window as the Project Overview chart.
// Takes a list rather than always averaging the whole team, so the
// Consultant view's chart can sync to whatever Level/Consultant filter is
// active there instead of always showing the global average.
export function getOccupationSeries(consultants = getConsultants()) {
  if (consultants.length === 0) {
    return Array.from({ length: WEEKS }, (_, w) => ({ week: `W${w + 1}`, occPct: 0 }));
  }
  const avgOcc = consultants.reduce((sum, c) => sum + c.occPct, 0) / consultants.length;
  const seed = consultants.map((c) => c.consultant).join('').length;
  return Array.from({ length: WEEKS }, (_, w) => ({
    week: `W${w + 1}`,
    occPct: Math.max(0, Math.round(avgOcc + Math.sin(w * 0.9 + seed) * 6 - (WEEKS - w) * 0.3)),
  }));
}

// Cumulative green days for a set of projects (defaults to all of Top
// Free) over the same window — also filterable, same reasoning as
// getOccupationSeries above.
export function getGreenDaysEvolution(projects = getProductivityTopFree()) {
  const totalGreenDays = projects.reduce((sum, r) => sum + r.greenDays, 0);
  return Array.from({ length: WEEKS }, (_, w) => ({
    week: `W${w + 1}`,
