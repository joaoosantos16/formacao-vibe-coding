...
export function getConsultants() {
  return [
    ...
    { consultant: 'pt asaraiva', level: 'Consultant', occPct: 75, fridayUtilPct: 58 },
    { consultant: 'pt acunha', level: 'Consultant', occPct: 69, fridayUtilPct: 52 },
    { consultant: 'pt joaosilva', level: 'Senior Consultant', occPct: 91, fridayUtilPct: 74 },
    { consultant: 'pt pcarvalho', level: 'Consultant', occPct: 63, fridayUtilPct: 48 },
    { consultant: 'pt jxavier', level: 'Associate', occPct: 55, fridayUtilPct: 40 },
    { consultant: 'pt martalemos', level: 'Associate', occPct: 48, fridayUtilPct: 35 },
    { consultant: 'pt aandion', level: 'Consultant', occPct: 71, fridayUtilPct: 55 },
  ];
}
