...
export const SECTOR_SUBSECTORS = {
  Retail: ['Mass Retail', 'Fashion', 'Electronics'],
  Manufacturing: ['Automotive', 'Consumer Goods', 'Chemical'],
  Energy: ['Energy Distribution', 'Renewables'],
  Logistics: ['Aviation', 'Road Transport', 'Warehousing'],
};
